        ...
        <div class="container">
            ...
            <div id="navmenu" class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="/admin/users" class="nav-link fw-bold active">Data User</a></li>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold mb-0 text-primary">
                <i class="fas fa-users me-2"></i>Data User Terdaftar
            </h2>
            <span class="badge badge-gradient">Total: {{ $users->count() }} User</span>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="stat-card primary">
                    ...
                    <h4>{{ $users->count() }}</h4>
                    <p class="mb-0 fw-semibold">Total User</p>
                </div>
            </div>
            <div class="col-md-3 mb-3">
            ...
            <div class="col-md-3 mb-3">
                <div class="stat-card success">
                    ...
                    <p class="mb-0 fw-semibold">Terverifikasi</p>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stat-card warning">
                    ...
                    <h4>{{ $users->where('email_verified_at', null)->count() }}</h4>
                    <p class="mb-0 fw-semibold">Belum Verifikasi</p>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>
                                <span class="badge {{ $user->role === 'admin' ? 'badge-admin' : 'badge-user' }} status-badge">
                            ...
                            <td>
                                <span class="badge {{ $user->email_verified_at ? 'badge-verified' : 'badge-unverified' }} status-badge">
                            ...
                            <td>
                                ...
                                <span class="text-muted small">
                                    <i class="fas fa-info-circle me-1"></i>Akun sendiri
                                </span>
                                @endif
                            </td>
                        </tr>
